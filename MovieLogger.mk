...
##
## Debug
ProjectName            :=MovieLogger
ConfigurationName      :=Debug
WorkspacePath          :=C:/programming/FirstWorkspace
ProjectPath            :=C:/programming/FirstWorkspace/MovieLogger
...
LinkerName             :=C:/compil/mingw64/bin/g++.exe
SharedObjectLinkerName :=C:/compil/mingw64/bin/g++.exe -shared -fPIC
ObjectSuffix           :=.o
DependSuffix           :=.o.d
PreprocessSuffix       :=.i
DebugSwitch            :=-g 
...
ObjectsFileList        :="MovieLogger.txt"
PCHCompileFlags        :=
MakeDirCommand         :=makedir
RcCmpOptions           := 
RcCompilerName         :=C:/compil/mingw64/bin/windres.exe
LinkOptions            :=  
...
##
AR       := C:/compil/mingw64/bin/ar.exe rcu
CXX      := C:/compil/mingw64/bin/g++.exe
CC       := C:/compil/mingw64/bin/gcc.exe
CXXFLAGS :=  -g -O0 -Wall $(Preprocessors)
CFLAGS   :=  -g -O0 -Wall $(Preprocessors)
ASFLAGS  := 
AS       := C:/compil/mingw64/bin/as.exe
...
$(IntermediateDirectory)/main.cpp$(ObjectSuffix): main.cpp
	...
	$(CXX) $(IncludePCH) $(SourceSwitch) "C:/programming/FirstWorkspace/MovieLogger/main.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/main.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/Movies.cpp$(ObjectSuffix): Movies.cpp
	...
	$(CXX) $(IncludePCH) $(SourceSwitch) "C:/programming/FirstWorkspace/MovieLogger/Movies.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/Movies.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/Movie.cpp$(ObjectSuffix): Movie.cpp
	...
	$(CXX) $(IncludePCH) $(SourceSwitch) "C:/programming/FirstWorkspace/MovieLogger/Movie.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/Movie.cpp$(ObjectSuffix) $(IncludePath)
